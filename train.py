...
def run_schedule(
    ...
    global_pi_calculator = GlobalPiCalculator(device=str(device), **config.schedule['pi_config'])
    ...
    trainer = Trainer(
        ...
        optimizer=optimizer,
        loss_fn=loss_fn,
        global_pi_calculator=global_pi_calculator,
        local_pi_calculator=local_pi_calculator,
