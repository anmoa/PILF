...
目标是观察不同学习策略在资源受限下的表现，从而更清晰地展示门控反向传播（Gated Backpropagation, GBP）等机制的优势。

**“不仅要训练你的模型，更要理解它的心智。”**

| **基线 ViT** | **4x1 MoE-ViT** | **16x4 MoE-ViT** | **带有 3σ 学习的 16x4 GBP-MoE-ViT** |
| :---: | :---: | :---: | :---: |
...
| **8x2 全程 (FashionMNIST -> MNIST)** | **8x2 预训练 + 8x2 GBP 排练 (FashionMNIST -> MNIST)** | **8x2 GBP 全程 (FashionMNIST -> MNIST)** |
| :---: | :---: | :---: |
