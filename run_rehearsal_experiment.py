...
def main():
    parser = argparse.ArgumentParser(description="Run a rehearsal experiment.")
    parser.add_argument('--config', type=str, required=True, help="Path to the configuration file.")
    parser.add_argument('--checkpoint_path', type=str, required=True, help="Path to a model checkpoint to load for rehearsal.")
    ...
    try:
        model, optimizer, loss_fn, pi_monitor, device, model_name = setup_experiment(
            config, base_model_name=config_name, model_name_suffix="-rehearsal", checkpoint_path=args.checkpoint_path
        )
